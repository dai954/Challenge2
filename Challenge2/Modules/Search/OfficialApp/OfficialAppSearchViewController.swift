...
//
//        let input = OfficialAppSearchViewModel.Input(viewWillAppearEvent: rx.viewWillAppear.asSignal().mapToVoid())
...
class OfficialAppSearchViewController: OfficialAppViewController {
